...
export default function Deploy() {
	...
	const getAllDeployment = useCallback(async () => {
		try {
			...
			console.log('🚀 ~ file: index.tsx:63 ~ getAllDeployment ~ res.data.data:', res.data.data)
		} catch (error) {
			console.log(error)
		} finally {
			setLoading(false)
