    ...
    return (
       <form onSubmit={_handleSubmit}>
        <div className={styles.modalWrapper}>
          <Input variant="form" label="Nama" onChange={handleChange} value={values.name} icon={<PersonIcon/>} name="name"/>
          <Input variant="form" label="Username" onChange={handleChange} value={values.username}icon={<PersonAddAlt1Icon  />} name="username"/>
          <Input variant="form" label="Password" onChange={handleChange} value={values.password} icon={<KeyIcon />} name="password"/>
          <Input variant="form" name="email" label="Email" onChange={handleChange} value={values.email} icon={<EmailIcon />} />
          <Input variant="form" name="namespaces" label="Namespaces" onChange={handleChange} value={values.namespaces} icon={<BadgeIcon />} />
          <Input variant="form" name="roleId" label="Role" onChange={handleChange} value={values.roleId} icon={<AdminPanelSettingsIcon />} />
          <div className={styles.bottom}>
            <Button className={styles.add} type="submit">Tambahkan</Button>
            <Button className={styles.batal} onClick={()=>setOpen(!open)}>Batal</Button>
          </div>
        </div>
      </form>
    )
