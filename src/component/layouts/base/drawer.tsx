			...
			<div key={index}>
				...
				{item.sub.map((subItem, subIndex): any => {
					return (
						<div
							key={subIndex}
							className={clsx(styles.drawerItemSubItem, active.includes(item.title) && styles.active, path === subItem.link && styles.actived)}
						>
	...
	return (
		<div className="flex flex-col justify-between space-y-10">
			...
			<div className="ml-8 pb-6">
				<button onClick={logoutHandler} className="text-lg flex items-center space-x-2">
